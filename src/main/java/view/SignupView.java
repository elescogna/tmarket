...
public class SignupView
    ...
    public SignupView(SignupController controller,
        ...
        uoftEmailTextField.addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {
                SignupState currentState = signupViewModel.getState();
        ...
        repeatPasswordTextField.addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {
                SignupState currentState = signupViewModel.getState();
        ...
        signUp.addActionListener(
                // This creates an anonymous subclass of ActionListener and instantiates
                // it.
                new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        if (evt.getSource().equals(signUp)) {
                            ...
                            signupController.execute(
                                    ...
                                    currentState.getPickupAddress(), currentState.getUoftEmail());
                        }
                    }
                });
    }
