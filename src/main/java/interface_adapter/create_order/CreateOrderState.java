...
public class CreateOrderState {
    ...
    public String getSameAddress() { return sameAddress; }
    ...
    public String toString() {
        return "CreateOrderState{"
            + "Student name='" + student.getName() + '\'' + ", buyerEmail='" +
            buyerEmail + '\'' + ", sameAddress='" + sameAddress + '\'' +
            ", otherAddress='" + otherAddress + '\'' + ", item ID='" +
            item.getId() + '\'' + '}';
    }
}
