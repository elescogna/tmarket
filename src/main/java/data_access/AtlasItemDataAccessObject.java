...
import use_case.ItemDataAccessInterface;

public class AtlasItemDataAccessObject implements ItemDataAccessInterface {
    ...
    private static final String atlasCollectionName = "items";
